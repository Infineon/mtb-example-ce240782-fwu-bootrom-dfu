...
APPNAME=mtb-example-ce240782-fwu-bootrom-dfu
...
#ifeq ($(TARGET), APP_KIT_PSC3M5_EVK)
#LINKER_SCRIPT=./templates/TARGET_KIT_PSC3M5_EVK/config/custom_linker_s_flash.ld
#endif
