...
* File Name:   main.c
*
* Description: This is the source code for Factory programming through BootROM
* DFU using PDL APIs. This code example guides the user to program the OEM 
* image using BootROM DFU serial interface. The DFU protocol is a properatory 
* infineon ownded serial interface feature inbuilt with an immutable BootROM
* for ModusToolbox.
*
